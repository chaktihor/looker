view: DC_CALENDAR_DATE {
  ...
  dimension: TRANSACTION_DATE {
    ...
    type: date }
  dimension: TRANSACTION_DATE_DAY {
    label: "TRANSACTION_DATE_DAY"
    sql: ${TABLE}.TRANSACTION_DATE_DAY ;;
    type: date }
  dimension: TRANSACTION_DATE_MONTH {
    label: "TRANSACTION_DATE_MONTH"
    sql: ${TABLE}.TRANSACTION_DATE_MONTH ;;
    type: date }
  dimension: TRANSACTION_DATE_QUARTER {
    label: "TRANSACTION_DATE_QUARTER"
    sql: ${TABLE}.TRANSACTION_DATE_QUARTER;;
    type: date }
  dimension: TRANSACTION_DATE_YEAR {
    label: "TRANSACTION_DATE_YEAR"
    sql: ${TABLE}.TRANSACTION_DATE_YEAR;;
    type: date }
